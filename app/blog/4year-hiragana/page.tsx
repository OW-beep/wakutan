      ...
      <article className="max-w-4xl mx-auto">
        ...
        <div className="bg-emerald-50 border-l-4 border-emerald-500 p-5 rounded-2xl my-8">
          ...
          <p className="leading-7">
            わが家でひらがなを始めたきっかけは、絵本や看板などで文字に興味を持ち始めたことでした。「4歳になったから教えよう」と決めていたわけではなく、「これ何て読むの？」と聞いてくることが増えてきたので、そろそろ始めてもいいかなという感じでした。周りの子が読めるようになっていると比べてしまい「まだ早いかな」と迷った時期もありましたが、興味がない状態で無理に覚えさせても続かないので、まずは自分の名前や好きなキャラクターの名前など、本人に関係する文字から始めました。「教え始める年齢」よりも「本人が文字に興味を持ったタイミング」を見る方が大切だったと感じています。
          </p>
        </div>
