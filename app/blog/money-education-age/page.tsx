      ...
      <article className="max-w-4xl mx-auto">
        ...
        <div className="bg-emerald-50 border-l-4 border-emerald-500 p-5 rounded-2xl my-8">
          ...
          <p className="leading-7">
            お小遣いを始める前から、お金について話す機会は意外とあります。一番身近なのは買い物で、「これとこれだったら、どっちが高い？」と聞いたり、「100円で買えるかな？」と考えてもらったりしています。上の子（5歳）くらいになると、レジでお金を払っているところにも興味を持つので、「お店の人にお金を渡して、商品をもらうんだよ」と説明することもあります。また「欲しいものを全部買えるわけではない」ということも少しずつ伝えていて、「今日はこれを買うから、これはまた今度にしよう」という会話をするだけでも、我慢することや選ぶことにつながっていると感じます。まだ本格的なお金の教育というより、「お金には限りがあって、何かを選ぶために使うもの」という感覚を、日常の買い物から少しずつ身につけてもらえればいいかなと思っています。
          </p>
        </div>
