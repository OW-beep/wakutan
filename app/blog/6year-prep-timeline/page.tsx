      ...
      <article className="max-w-4xl mx-auto">
        ...
        <div className="bg-emerald-50 border-l-4 border-emerald-500 p-5 rounded-2xl my-8">
          ...
          <p className="leading-7">
            小学校準備は、入学直前に一気に始めるというより、1年くらい前から少しずつ意識するのがいいと考えています。まず意識したいのは学習よりも生活面です。自分で着替える、ランドセルや持ち物を準備する、朝起きる時間をある程度整える、話を聞いて行動する、といったことです。その上で、入学が近づいてきたらひらがなや数字、簡単な読み書きなどを確認していくイメージです。5歳の今からできることとして、朝の準備を少しずつ自分でやってもらったり、ドリルも「親が全部教える」のではなく「まず自分で考えてみる」という時間を作ったりしています。入学前の最後の数ヶ月で焦って詰め込むより、1年前くらいから生活の中に少しずつ取り入れておく方が、子どもにとっても親にとっても負担が少ないと感じています。
          </p>
        </div>
