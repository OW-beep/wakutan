  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-yellow-50 to-white p-6">
      ...
      <article className="max-w-4xl mx-auto">
        ...
        <p className="leading-8 mb-4">
          最初から「長い針が分、短い針が時間」と教えるより、生活の中の時間と結びつけた方が入りやすいこともあります。「長い針が6になったらお風呂」「短い針が8になったら寝る」というように、毎日の生活の節目と時計を結びつけると、数字としてではなく、実感として時計を捉えられるようになっていきます。
        </p>
        ...
        <div className="bg-emerald-50 border-l-4 border-emerald-500 p-5 rounded-2xl my-8">
          ...
          <p className="leading-7">
            最初は「3時」と「3時半」の違いがかなり難しかったです。短い針だけを見て「3」と答えてしまうこともありました。そこで、「今は何時？」だけでなく、「長い針はどこにある？」と分けて聞くようにしました。ある日、こちらが何も言っていないのに時計を見て、「もうすぐお風呂の時間だよ」と言ったことがあり、そこで初めて「時計を読める」というのは、数字を覚えることだけじゃなく、生活の中で時間を意識することなんだなと感じました。わが家の長女は、計算問題は得意な一方、時計を読むのは今でも少し苦手です。同じ子でも、分野によって得意・不得意がはっきり分かれることを実感しています。計算ができるからといって時計もすぐ読めるとは限らないので、「これは別のスキル」と割り切って、焦らず個別に付き合うようにしています。
          </p>
        </div>
        ...
        <div className="space-y-4 mb-6">
          <div>
            <p className="font-bold">Q. 短い針と長い針、どちらから教えるべき？</p>
            <p className="leading-7 text-gray-700">A. 短い針（時間）から始めるのがおすすめです。「今は何時？」と「長い針はどこにある？」を分けて聞くことで、2本の針の役割の違いが整理しやすくなります。</p>
          </div>
          <div>
            <p className="font-bold">Q. デジタル時計しか読めません。アナログも教えるべき？</p>
            <p className="leading-7 text-gray-700">A. 両方に触れておくのがおすすめです。アナログ時計は針の位置から「あと何分」という感覚もつかみやすいので、生活の中で少しずつ触れる機会を作ってみてください。</p>
          </div>
          <div>
            <p className="font-bold">Q. 算数が得意なのに時計だけ苦手です。心配すべき？</p>
            <p className="leading-7 text-gray-700">A. よくあることです。時計を読む力は計算力とは別のスキルなので、得意・不得意が分かれても心配しすぎる必要はありません。焦らず生活の中で繰り返し触れていきましょう。</p>
          </div>
        </div>
