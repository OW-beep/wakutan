...
export const metadata = {
  ...
  description:
    "6歳向け無料算数ドリル。たし算・ひきざんの基礎を毎日30問。無料で印刷OK。",
  alternates: {
    canonical: "/6/sansu",
  },
};
  ...
  return (
    <main className="min-h-screen bg-yellow-50">
      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-2xl p-5 mb-8 flex flex-wrap gap-x-8 gap-y-2 text-sm print-hide">
