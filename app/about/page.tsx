    ...
    <main className="min-h-screen bg-gradient-to-b from-yellow-50 to-white p-6">
      ...
      <article className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow p-8 mt-8">
          ...
          <p className="mb-4">
            わくたんを作った直接のきっかけは、実は自分の子どもとの家庭学習でした。市販のドリルは内容自体はよいのですが、1冊終わるたびに次を買い足す必要があり、「次は何をやらせよう」と毎回悩んでいました。同じ形式の問題が続くと子どもが飽きてしまい、せっかく始めた学習習慣が途切れてしまうこともありました。「毎日少しずつ、迷わず続けられる仕組みを作れないか」と考えたのが、わくたんの出発点です。
          </p>

          <p className="mb-4">
            また、運営者自身も3人の子ども（上から幼児〜小学校低学年）を育てている保護者であり、
          ...
          <p className="mb-4">
            実際に問題を作る中で気づいたこともあります。最初は「たくさんやらせた方がいいのでは」と問題数を増やしたこともありましたが、途中で集中が切れてしまい、逆に続かなくなりました。1回で終わる分量に絞ったところ、「今日はこれだけやればOK」という安心感が生まれ、家庭でも続けやすくなりました。逆に、同じ力を試す問題でも、同じ形式をただ繰り返すだけでは子どもはすぐに飽きてしまうため、題材や見せ方を変える工夫を重ねています。なぞなぞや仲間分け、間違い探しのような、少しゲーム性のある問題に子どもたちが自分から取り組む姿を見たことも、わくたんの問題づくりの方向性に大きく影響しています。
          </p>
