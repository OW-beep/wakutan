    ...
    <main>
      ...
      <section className="max-w-4xl mx-auto px-6 mb-14">
        ...
        <div className="space-y-3">
          {[
            ...
            { emoji: "🚩", title: "こっき問題", desc: "世界の国旗を観察して、模様の特徴を見つける問題", key: "kokki", ages: [4, 5, 6] },
      ...
      <section className="max-w-4xl mx-auto px-6 mb-14">
        ...
        <div className="bg-white rounded-3xl shadow p-8 border-t-4 border-blue-300">
          ...
          <p className="leading-8 mt-4">
            わくたんでは、各ジャンル30問のドリルと、複数ジャンルから10問を試せる「今日のドリル」を通して、
          ...
          <p className="leading-8 mt-4">
            ...
            難しい課題にも粘り強く取り組む傾向が示されているといわれています。
